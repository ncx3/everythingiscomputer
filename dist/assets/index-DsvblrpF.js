...
void main() {
	...
	`}var bs=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};bd.BlurDirectionX=new W(1,0),bd.BlurDirectionY=new W(0,1);var xd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Sd=class extends ud{constructor(){super(),this.isOutputPass=!0,this.uniforms=da.clone(xd.uniforms),this.material=new ha({name:xd.name,uniforms:this.uniforms,vertexShader:xd.vertexShader,fragmentShader:xd.fragmentShader}),this._fsQuad=new pd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Cd=2560,wd=1684,Td=96,Ed=33,Dd=Cd/Td,Od=wd/Ed,$={chrome:`#2f8a60`,dim:`#3ea877`,text:`#5cffae`,bright:`#c9ffe4`,alert:`#ff6b5c`,amber:`#ffc457`,redact:`#1f6547`},kd=29;function Ad(){let e=document.createElement(`canvas`);e.width=Cd,e.height=wd;let t=e.getContext(`2d`),n=document.createElement(`canvas`);n.width=Cd,n.height=wd;let r=n.getContext(`2d`),i=`ui-monospace, "Cascadia Mono", "DejaVu Sans Mono", Consolas, monospace`;r.font=`100px ${i}`;let a=r.measureText(`M`).width||60,o=`${(100*Dd/a).toFixed(2)}px ${i}`,c=Od*.74,u=jd(t),d=Array(3168),f=Array(3168),p=Array(3168),m=new ea(e);m.colorSpace=ze,m.anisotropy=8,m.generateMipmaps=!0,m.minFilter=l,m.magFilter=s;let h=(e,t)=>t*Td+e,g=(e,t)=>e>=0&&e<Td&&t>=0&&t<Ed;function _(){d.fill(` `),f.fill($.dim),p.fill(null)}function v(e,t,n,r,i){if(!g(e,t))return;let a=h(e,t);d[a]=n,f[a]=r||$.dim,i!==void 0&&(p[a]=i)}function y(e,t,n,r,i){for(let a=0;a<n.length;a++)v(e+a,t,n[a],r,i)}function b(e,t,n,r,i){for(let a=0;a<n;a++)v(e+a,t,r,i)}function x(e,t){for(let n=0;n<Td;n++)g(n,e)&&(p[h(n,e)]=t)}function S(e){_(),b(0,0,Td,`─`,$.chrome),v(0,0,`┌`,$.chrome),v(95,0,`┐`,$.chrome);for(let e=1;e<=29;e++)v(0,e,`│`,$.chrome),v(95,e,`│`,$.chrome),v(kd,e,`│`,$.chrome);b(0,30,Td,`─`,$.chrome),v(0,30,`├`,$.chrome),v(95,30,`┤`,$.chrome),v(kd,30,`┴`,$.chrome),v(0,31,`│`,$.chrome),v(95,31,`│`,$.chrome),b(0,32,Td,`─`,$.chrome),v(0,32,`└`,$.chrome),v(95,32,`┘`,$.chrome),y(2,0,` GENOCYBER OS `,$.bright),y(16,0,` v2.7.1 `,$.dim);let t=` SYS.NOMINAL ── ${new Date().toTimeString().slice(0,8)} `;y(94-t.length,0,t,$.text);let n=2;y(2,n++,`/`,$.dim),n++,y(2,n,`├─▸ BRIEF`,$.text),n++,y(2,n,`├─▾ PERSONNEL`,$.bright),y(24,n,`[3]`,$.dim),x(n,null);for(let e=1;e<kd;e++)p[h(e,n)]=`rgba(92,255,174,.12)`;n++;for(let e of[`├─ 01 ████████`,`├─ 02 ██████████`,`└─ 03 ███████`])y(2,n,`│  `,$.chrome),y(5,n,e.slice(0,6),$.dim),y(11,n,e.slice(6),$.redact),n++;y(2,n,`├─▸ SURVEILLANCE_LOG`,$.text),y(24,n,`[1]`,$.dim),n++,y(2,n,`└─▸ COMMS`,$.text),y(24,n,`[4]`,$.dim),n+=3,y(2,25,`── LINK ────────────────`,$.chrome),y(2,26,`UPLINK ......... STABLE`,$.dim),y(2,27,`AUTH ............ GUEST`,$.dim),y(2,28,`CLEARANCE ..... LIMITED`,$.alert),y(31,2,`/PERSONNEL`,$.bright),b(31,3,63,`─`,$.chrome);let r=[[`01`,`████████`,`███████████`,`AAA`],[`02`,`██████████`,`█████████`,`AAA`],[`03`,`███████`,`████████████`,`AAA`]],i=5;for(let[e,t,n,a]of r)y(31,i,`▸ ${e}`,$.amber),y(37,i,t,$.redact),i++,y(37,i,`ROLE ............. `,$.chrome),y(56,i,n,$.redact),i++,y(37,i,`CLEARANCE ........ `,$.chrome),y(56,i,a,$.dim),i+=2;y(31,27,`3 RECORDS ── END OF DIRECTORY`,$.chrome),y(74,27,` GENOCYBER INTERNAL `,$.alert);let a=Math.floor(e*1.6)%2==0;y(2,31,`>`,$.text),y(4,31,`open /personnel`,$.bright),a&&y(20,31,`█`,$.text),C(e)}function C(e){t.globalCompositeOperation=`source-over`,t.globalAlpha=1,t.filter=`none`;let i=t.createRadialGradient(Cd*.5,wd*.44,wd*.1,Cd*.5,wd*.5,wd*.95);i.addColorStop(0,`#08160f`),i.addColorStop(1,`#030805`),t.fillStyle=i,t.fillRect(0,0,Cd,wd),r.clearRect(0,0,Cd,wd),r.font=o,r.textBaseline=`alphabetic`;for(let e=0;e<Ed;e++){let t=0;for(;t<Td;){let n=p[h(t,e)];if(n){let i=1;for(;t+i<Td&&p[h(t+i,e)]===n;)i++;r.fillStyle=n,r.fillRect(t*Dd,e*Od,i*Dd,Od),t+=i}else t++}for(t=0;t<Td;){let n=f[h(t,e)],i=1;for(;t+i<Td&&f[h(t+i,e)]===n&&d[h(t+i,e)]!==` `;)i++;let a=``;for(let n=0;n<i;n++)a+=d[h(t+n,e)];a.trim()&&(r.fillStyle=n,r.fillText(a,t*Dd,e*Od+c)),t+=i}}t.globalCompositeOperation=`lighter`,t.filter=`blur(7px)`,t.globalAlpha=.55,t.drawImage(n,0,0),t.filter=`none`,t.globalAlpha=1,t.drawImage(n,0,0),t.globalCompositeOperation=`source-over`,t.fillStyle=u,t.fillRect(0,0,Cd,wd);let a=(e*.06%1.4-.2)*wd,s=t.createLinearGradient(0,a,0,a+wd*.16);s.addColorStop(0,`rgba(92,255,174,0)`),s.addColorStop(.5,`rgba(92,255,174,.035)`),s.addColorStop(1,`rgba(92,255,174,0)`),t.fillStyle=s,t.fillRect(0,a,Cd,wd*.16);let l=t.createRadialGradient(Cd*.5,wd*.5,wd*.35,Cd*.5,wd*.5,wd*.85);l.addColorStop(0,`rgba(0,0,0,0)`),l.addColorStop(1,`rgba(0,0,0,.55)`),t.fillStyle=l,t.fillRect(0,0,Cd,wd),m.needsUpdate=!0}let w=-1;return{texture:m,aspect:Cd/wd,update(e){e-w<.125||(w=e,S(e))},dispose(){m.dispose()}}}function jd(e){let t=document.createElement(`canvas`);t.width=1,t.height=4;let n=t.getContext(`2d`);return n.fillStyle=`rgba(0,0,0,.34)`,n.fillRect(0,0,1,2),n.fillStyle=`rgba(0,0,0,0)`,n.fillRect(0,2,1,2),e.createPattern(t,`repeat`)}var Md={contain:{pad:1.14,mode:`contain`,of:`model`},cover:{pad:1,mode:`cover`,of:`model`},docked:{pad:1.05,mode:`contain`,of:`screen`}},Nd=document.getElementById(`gl`),Pd=document.getElementById(`loading`),Fd=document.getElementById(`pct`),Id=document.getElementById(`domlayer`),Ld=document.getElementById(`domrect`),Rd=new iu({canvas:Nd,antialias:!0,powerPreference:`high-performance`});Rd.setPixelRatio(Math.min(window.devicePixelRatio,2)),Rd.setSize(window.innerWidth,window.innerHeight),Rd.outputColorSpace=ze,Rd.toneMapping=4,Rd.toneMappingExposure=1.05;var zd=new jn,Bd=new lo(34,window.innerWidth/window.innerHeight,.05,100);zd.environment=new ds(Rd).fromScene(new sd,.04).texture,zd.environmentIntensity=.4;var Vd=new _o(14149375,2.4);Vd.position.set(-2.2,2.4,-3.2),zd.add(Vd);var Hd=new _o(7446783,.7);Hd.position.set(3,-.6,-2.2),zd.add(Hd);var Ud=new _o(6094766,1.1);Ud.position.set(.6,1,3),zd.add(Ud),zd.add(new vo(2241348,.6)),zd.add(df());var Wd=new Bo,Gd=Ad(),Kd=null,qd=null,Jd=new G(0,0,-1),Yd=new Kn,Xd=new Kn,Zd=`contain`,Qd=!0,$d=!1,ef=!1,tf={target:new G,distance:3,from:{target:new G,distance:3},to:{target:new G,distance:3},t:1,dur:1.15},nf={yaw:0,pitch:0,yawTo:0,pitchTo:0,zoom:1},rf={x:0,y:0,dragging:!1,lastX:0,lastY:0};new cu().load(`/models/deck.glb`,e=>{Kd=e.scene,zd.add(Kd),Kd.updateWorldMatrix(!0,!0),qd=Kd.getObjectByName(`Screen_Low.001_Monitor_0`),qd||Kd.traverse(e=>{e.isMesh&&/screen/i.test(e.name)&&!qd&&(qd=e)}),qd&&(Jd=lf(qd),uf(qd,Jd),qd.material=new ga({color:0,emissive:16777215,emissiveMap:Gd.texture,emissiveIntensity:1.35,roughness:.22,metalness:0}),Xd.setFromObject(qd)),Yd.setFromObject(Kd),sf(`contain`,!0),Pd.classList.add(`done`),setTimeout(()=>Pd.remove(),700)},e=>{e.lengthComputable&&(Fd.textContent=`${Math.round(e.loaded/e.total*100)}%`)},e=>{Fd.textContent=`FAILED`,console.error(`[genocyber] deck failed to load`,e)});var af=new _d(Rd);af.addPass(new vd(zd,Bd));var of=new bd(new W(window.innerWidth,window.innerHeight),.62,.55,.68);af.addPass(of),af.addPass(new Sd),af.setSize(window.innerWidth,window.innerHeight);function sf(e,t=!1){if(!Md[e]||!Kd)return;Zd=e;let n=Md[e],r=n.of===`screen`&&qd?Xd:Yd,i=new G,a=new G;r.getSize(i),r.getCenter(a);let o=cf(i,Bd,n.mode,n.pad);tf.from.target.copy(tf.target),tf.from.distance=tf.distance,tf.to.target.copy(a),tf.to.distance=o,tf.t=+!!t,t&&(tf.target.copy(a),tf.distance=o),nf.zoom=1,e===`docked`&&(nf.yawTo=0,nf.pitchTo=0);for(let t of document.querySelectorAll(`#hud [data-state]`))t.classList.toggle(`on`,t.dataset.state===e)}function cf(e,t,n,r){let i=Math.tan(Et.degToRad(t.fov)*.5),a=e.y*r*.5/i,o=e.x*r*.5/(i*t.aspect);return(n===`cover`?Math.min(a,o):Math.max(a,o))+e.z*.5}function lf(e){let t=e.geometry.attributes.normal,n=new G,r=new G;for(let e=0;e<t.count;e++)r.add(n.fromBufferAttribute(t,e));return r.normalize().transformDirection(e.matrixWorld).normalize(),r.z>0&&r.negate(),r}function uf(e,t){let n=e.geometry;n.computeBoundingBox();let r=n.boundingBox,i=new G;r.getSize(i);let a=[i.x,i.y,i.z],o=a.indexOf(Math.min(...a)),[s,c]=[0,1,2].filter(e=>e!==o),l=e=>new G(+(e===0),+(e===1),+(e===2)),u=new G().crossVectors(new G(0,1,0),t).normalize(),d=l(s).transformDirection(e.matrixWorld).normalize(),f=l(c).transformDirection(e.matrixWorld).normalize(),p=d.dot(u)<0,m=f.y<0,h=n.attributes.position,g=new Float32Array(h.count*2),_=[`x`,`y`,`z`],v=r.min[_[s]],y=r.min[_[c]],b=a[s]||1,x=a[c]||1;for(let e=0;e<h.count;e++){let t=new G().fromBufferAttribute(h,e),n=(t[_[s]]-v)/b,r=(t[_[c]]-y)/x;p&&(n=1-n),m&&(r=1-r),g[e*2]=n,g[e*2+1]=r}n.setAttribute(`uv`,new ur(g,2))}function df(){let e=document.createElement(`canvas`);e.width=e.height=512;let t=e.getContext(`2d`),n=t.createRadialGradient(256,236,20,256,256,300);n.addColorStop(0,`#16232b`),n.addColorStop(.45,`#0a1015`),n.addColorStop(1,`#04070a`),t.fillStyle=n,t.fillRect(0,0,512,512);let r=new ea(e);r.colorSpace=ze;let i=new Zr(new aa(30,22),new zr({map:r,depthWrite:!1}));return i.position.z=6,i.renderOrder=-1,i}var ff=new G;function pf(){if(!ef||!qd)return;let e=1/0,t=1/0,n=-1/0,r=-1/0,i=Xd;for(let a=0;a<8;a++){ff.set(a&1?i.max.x:i.min.x,a&2?i.max.y:i.min.y,a&4?i.max.z:i.min.z),ff.project(Bd);let o=(ff.x*.5+.5)*window.innerWidth,s=(-ff.y*.5+.5)*window.innerHeight;e=Math.min(e,o),n=Math.max(n,o),t=Math.min(t,s),r=Math.max(r,s)}Ld.style.left=`${e}px`,Ld.style.top=`${t}px`,Ld.style.width=`${n-e}px`,Ld.style.height=`${r-t}px`}addEventListener(`pointerdown`,e=>{e.target instanceof Element&&e.target.closest(`#hud`)||(rf.dragging=!0,rf.lastX=e.clientX,rf.lastY=e.clientY)}),addEventListener(`pointerup`,()=>rf.dragging=!1),addEventListener(`pointercancel`,()=>rf.dragging=!1),addEventListener(`pointermove`,e=>{rf.x=e.clientX/window.innerWidth*2-1,rf.y=e.clientY/window.innerHeight*2-1,rf.dragging&&(nf.yawTo=hf(nf.yawTo+(e.clientX-rf.lastX)*.0022,-.32,.32),nf.pitchTo=hf(nf.pitchTo-(e.clientY-rf.lastY)*.0022,-.22,.22),rf.lastX=e.clientX,rf.lastY=e.clientY)}),addEventListener(`wheel`,e=>{nf.zoom=hf(nf.zoom*(1+Math.sign(e.deltaY)*.06),.45,2)},{passive:!0}),addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();t===`1`&&sf(`contain`),t===`2`&&sf(`cover`),t===`3`&&sf(`docked`),t===`d`&&mf(`dom`),t===`b`&&mf(`bloom`),t===`r`&&mf(`drift`)}),document.getElementById(`hud`).addEventListener(`click`,e=>{let t=e.target.closest(`button`);t&&(t.dataset.state&&sf(t.dataset.state),t.dataset.toggle&&mf(t.dataset.toggle))});function mf(e){e===`dom`&&(ef=!ef,Id.hidden=!ef),e===`bloom`&&(Qd=!Qd),e===`drift`&&($d=!$d);let t=document.querySelector(`#hud [data-toggle="${e}"]`);t&&t.classList.toggle(`on`,e===`dom`?ef:e===`bloom`?Qd:$d)}addEventListener(`resize`,()=>{Bd.aspect=window.innerWidth/window.innerHeight,Bd.updateProjectionMatrix(),Rd.setSize(window.innerWidth,window.innerHeight),af.setSize(window.innerWidth,window.innerHeight),of.setSize(window.innerWidth,window.innerHeight),sf(Zd,!0)});var hf=(e,t,n)=>Math.min(n,Math.max(t,e)),gf=e=>e<.5?4*e*e*e:1-(-2*e+2)**3/2,_f=new an(0,0,0,`YXZ`),vf=new Dt,yf=new G;function bf(){requestAnimationFrame(bf);let e=Math.min(Wd.getDelta(),.05),t=Wd.elapsedTime;if(Gd.update(t),tf.t<1){tf.t=Math.min(1,tf.t+e/tf.dur);let t=gf(tf.t);tf.target.lerpVectors(tf.from.target,tf.to.target,t),tf.distance=Et.lerp(tf.from.distance,tf.to.distance,t)}let n=Zd===`docked`,r=n?0:.055,i=$d&&!n?Math.sin(t*.22)*.05:0,a=nf.yawTo+(rf.dragging?0:-rf.x*r+i),o=nf.pitchTo+(rf.dragging?0:rf.y*r*.6);nf.yaw+=(a-nf.yaw)*Math.min(1,e*4),nf.pitch+=(o-nf.pitch)*Math.min(1,e*4),n&&(nf.yawTo+=(0-nf.yawTo)*Math.min(1,e*4),nf.pitchTo+=(0-nf.pitchTo)*Math.min(1,e*4)),_f.set(nf.pitch,nf.yaw,0),vf.setFromEuler(_f),yf.copy(Jd).applyQuaternion(vf).multiplyScalar(tf.distance*nf.zoom),Bd.position.copy(tf.target).add(yf),Bd.lookAt(tf.target),pf(),Qd?af.render():Rd.render(zd,Bd)}bf();